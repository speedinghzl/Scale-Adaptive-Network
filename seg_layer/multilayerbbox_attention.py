...
class BatchLoader(object):
    ...
    def perpare_next_data(self):
        ...
        annotation = load_pascal_annotation(img_id, self.voc_dir)
...
class SimpleTransformer:
    ...
    def __init__(self, params):
        ...
        self.scale_threshold = self.load_object(osp.join(osp.dirname(__file__), 'new_scales.pkl'))
